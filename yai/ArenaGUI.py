...
performance_settings = {
    '매우 약함': dotdict({'numMCTSSims': 10, 'cpuct': 1.0}),
    '약함': dotdict({'numMCTSSims': 30, 'cpuct': 1.0}),
    '중간': dotdict({'numMCTSSims': 50, 'cpuct': 1.0}),
    '강함': dotdict({'numMCTSSims': 100, 'cpuct': 1.0}),
    '매우 강함': dotdict({'numMCTSSims': 500, 'cpuct': 1.0}),
    '신': dotdict({'numMCTSSims': 1000, 'cpuct': 1.0})
}